...
return [
    ...
    */
    ...
    'repository' => DigitalSeraph\Pages\Repository\EloquentPageRepository::class,
    ...
    */
    ...
    'page_model' => DigitalSeraph\Pages\Models\Page::class,
    'pages_table' => 'pages',
    'pages_table_primary_key' => 'id',
    ...
    */
    ...
    'admin_user_model' => App\Admin::class,
    'admin_users_table' => 'admins',
    'admin_users_table_primary_key' => 'id'
