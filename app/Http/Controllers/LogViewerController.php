...
use Rap2hpoutre\LaravelLogViewer\LogViewerController as RapLogViewer;

class LogViewerController extends RapLogViewer
{
    protected $request;
    ...
    public function index()
    {
        ...
        return app('view')->make('pages.debug.log', [
